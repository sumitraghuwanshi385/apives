...
import { 
  ...
  Radar, Zap, Bitcoin, Wallet, Truck, BarChart3, 
...
export const PopularApis: React.FC = () => {
  ...
  const loadCommunity = async (pageNumber: number) => {
        ...
        <div className="max-w-xs mx-auto mb-10 md:mb-16 relative">
          ...
          {showFilters && (
            <div className="absolute top-full left-1/2 -translate-x-1/2 w-screen max-w-4xl mt-4 px-4 z-[60]">
              <div className="bg-black border border-red-500/30 rounded-2xl p-6 shadow-xl backdrop-blur-xl">

                {/* PRICING */}
                <div className="mb-6">
                  <h4 className="text-xs font-black text-red-400 uppercase tracking-widest mb-3">
                    Pricing
                  </h4>
