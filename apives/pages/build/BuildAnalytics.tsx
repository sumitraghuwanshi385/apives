...
const STORAGE_KEY = "apives_usecase_analytics";
const NOTE_KEY = "apives_analytics_global_note";
  ...
  useEffect(() => {
    (async () => {
      try {
        ...
        console.error("Analytics API fetch failed", e);
      } finally {
        setLoading(false);
      }
    })();
    ...
    <div className="min-h-screen bg-black text-slate-100 pt-20 px-4 md:px-8">
      ...
      <div className="max-w-4xl mx-auto text-center mb-8">
        ...
        <p className="mt-3 text-slate-400 text-sm md:text-lg">
          Product analytics and event tracking APIs built for data-driven SaaS teams.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto mb-6 px-1">
        ...
        <p className="text-xs text-slate-400 max-w-xl">
          Analytics APIs selected for scalable, reliable product insights.
        </p>
      </div>
      ...
      {!loading && visibleApis.length === 0 && (
        <p className="text-center text-slate-500 mt-16 text-sm">
          No analytics APIs selected yet.
        </p>
      )}
    </div>
  );
