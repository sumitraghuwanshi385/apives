...
export const EnterprisePage: React.FC = () => (
  <PageLayout title="Enterprise" subtitle="High-scale support for organizations." icon={Activity}>
    ...
    <p>
        ...
        <div className="text-center py-10 bg-mora-500/5 border border-mora-500/20 rounded-3xl">
            <h3 className="text-xl font-bold text-white mb-4">Scaling Up?</h3>
            <p className="text-slate-400 mb-8 max-w-xs mx-auto text-sm">We provide dedicated support and higher limits for large-scale API integrations. Contact our sales team to discuss your needs.</p>
...
export const DocumentationPage: React.FC = () => (
  <PageLayout title="Documentation" subtitle="Learn how to use the grid." icon={FileText}>
    <div className="space-y-10 prose prose-invert max-w-none text-slate-400 text-sm md:text-base">
        <section>
            <h3 className="text-white text-xl md:text-2xl font-bold mb-4">Introduction to Apives</h3>
            <p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 not-prose">
            <div className="p-5 bg-white/5 border border-white/10 rounded-2xl">
                <h3 className="text-white font-bold mb-3 flex items-center gap-2 text-sm"><Rocket size={18} className="text-mora-500" /> Getting Started</h3>
            ...
            <div className="p-5 bg-white/5 border border-white/10 rounded-2xl">
                <h3 className="text-white font-bold mb-3 flex items-center gap-2 text-sm"><Zap size={18} className="text-mora-500" /> Posting APIs</h3>
                <p className="text-slate-400 text-[12px] leading-relaxed">
        ...
        <section>
            <h3 className="text-white text-xl md:text-2xl font-bold mb-4">Advanced Configuration</h3>
            <p>
...
export const StatusPage: React.FC = () => (
  <PageLayout title="System Status" subtitle="Current grid health and operational logs." icon={Activity}>
    <div className="space-y-8">
        <div className="flex items-center gap-4 bg-mora-500/10 p-5 rounded-2xl border border-mora-500/20">
            <div className="w-4 h-4 bg-mora-500 rounded-full animate-pulse shadow-[0_0_15px_rgba(34,197,94,0.6)]"></div>
            <span className="text-white font-bold text-base md:text-lg">All Systems Operational</span>
        </div>

        <div className="prose prose-invert max-w-none text-slate-400 text-sm md:text-base">
            <p>
        ...
        <div className="space-y-4">
            <h4 className="text-white font-bold uppercase tracking-widest text-[10px]">Recent Incident Logs</h4>
            <div className="bg-white/5 border border-white/10 rounded-2xl overflow-hidden font-mono text-[9px]">
