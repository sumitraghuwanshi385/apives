...
=========================================================
  ...
  Keeps fetched API results while the SPA is open.
...
export const BrowseApis: React.FC = () => {
  ...
  const [searchTerm, setSearchTerm] = useState(
    savedBrowseState.searchTerm
  );

  const [selectedCategory, setSelectedCategory] =
    useState(
      savedBrowseState.selectedCategory
    );
  ...
  */
    ...
    */
    ...
    try {
      ...
      const res = await fetch(
        `${API_BASE}/api/apis?${params.toString()}`,
        {
          method: "GET",
          headers: {
      ...
      /*
      -------------------------------------------------------
        ONLY SHUFFLE A BRAND NEW FIRST PAGE

        Cached results NEVER get shuffled again.
      -------------------------------------------------------
      */
      ...
      */
      ...
      if (
        ...
        try {
          const rankRes =
            await fetch(
              `${API_BASE}/api/community?page=1&limit=3`,
              {
                method: "GET",
                headers: {
                  Accept:
  ...
  =======================================================
    ...
    This removes the old duplicate initial request.
  =======================================================
  */
